  ...
  <div id="login" class="sub">
    <div class="container">
      ...
      <div class="login-wrap">
        <div class="login-top">
          <p class="f_corm login-title">LOGIN</p>
        </div>
          ...
          <div class="login-box">
            <fieldset id="login_fs">
              ...
              <div class="login-box-bot">
                ...
                <div class="i-col-2 btn-wrap login-btn-wrap">
                  <div class="btn-item">
                    <a class="btn type01" href="<?php echo G5_BBS_URL ?>/register.php">회원가입</a>
                  </div>
                  <div class="btn-item">
                    <a class="btn type01" href="<?php echo G5_BBS_URL ?>/password_lost.php">아이디/비밀번호 찾기</a>
                  </div>
                </div>
              </div>
            </fieldset> 
