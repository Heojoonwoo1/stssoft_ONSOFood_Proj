...
//EUM 추가 경로
define('ONSO_CSS_DIR',        '/source/css');
define('ONSO_JS_DIR',         '/source/js');
define('ONSO_PLUGIN_DIR',     '/source/plugin');

define('ONSO_JS_URL',         G5_URL.'/'.ONSO_JS_DIR);
define('ONSO_CSS_URL',        G5_URL.'/'.ONSO_CSS_DIR);
define('ONSO_PLUGIN_URL',     G5_URL.'/'.ONSO_PLUGIN_DIR);

define('ONSO_INCLUDE_DIR',      'include');

define('ONSO_INCLUDE_PATH',      G5_PATH.'/'.ONSO_INCLUDE_DIR);
//==============================================================================
